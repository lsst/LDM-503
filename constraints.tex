...
\item Verification is being done on the basis of precursor data sets such as HSC (see for example \secref{LDM-503-2}), and eventually with engineering data from the LSST camera test stands and commissioning camera. These are just a proxy for full-focal-plane on-site LSST data.
