...
The test reports will be used to populate the verification control document see \secref{sect:approach}. We are monitoring the LSST System Engineer's approach to plan commissioning tests for LSST system-wide verification and will evaluate the merits of using the same toolchain for \product\ verification.
