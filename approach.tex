...
The \textbf{Test Specification} for a product collects all of the test cases that cover that particular product.
...
Test Specifications consist of a mixture of material which are directly written and curated in GitHub by the corresponding product owner, and sections which are automatically generated from the contents of Jira.
